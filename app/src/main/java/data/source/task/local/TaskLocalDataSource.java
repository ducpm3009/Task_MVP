...
public class TaskLocalDataSource extends TaskLocalDbHelper
    ...
    public void addTask(Task task, Callback<Integer> callback) {
        if (task == null) callback.onFailed(String.valueOf(R.string.add_failed));
    ...
    public void deleteTask(int id, Callback<Integer> callback) {
        ...
        if (result > 0) {
            ...
            callback.onFailed(String.valueOf(R.string.delete_failed));
        }
    }
    ...
    public void getTasks(Callbacks<Task> callbacks) {
        ...
        db.close();
        if (tasks.isEmpty()) {
            callbacks.onFailed(String.valueOf(R.string.get_failed));
        } else {
    ...
    public void getTaskByID(int id, Callback<Task> callback) {
        ...
        if (task != null) {
            ...
            callback.onFailed(String.valueOf(R.string.search_failed));
        }
    }
