...
public class MainPresenter implements MainContract.Presenter {
    ...
    public MainPresenter(MainContract.View mView, TaskDataSource mTaskRepository) {
        this.mView = mView;
    ...
    @Override
    public void deleteTask(final List<Task> tasks, final int id, String msg) {
