...
public class MainActivity extends AppCompatActivity
    ...
    public MainActivity(MainContract.Presenter mPresenter, RecyclerView mRecyclerTask,
            TaskAdapter mTaskAdapter, List<Task> mTaskList) {
        this.mPresenter = mPresenter;
        this.mRecyclerTask = mRecyclerTask;
